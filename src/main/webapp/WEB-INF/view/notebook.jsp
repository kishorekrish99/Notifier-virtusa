...
<body>
	...
	<div class="wrapper d-flex align-items-stretch">
		...
		<div id="content" class="p-4 p-md-5 pt-5">
			...
			<!-- Page Content -->
			<h2 class="mb-4"  align="center"><u>NOTEBOOKS</u></h2>
			<div style="padding-left:80%;">
				<button type="button" class="btn btn-primary" ><a data-toggle="modal" data-target="#addnotebook" style="color:white">Add NoteBooks</a></button>
			</div>
			<!-- demo content -->			
			<div class="modal fade" id="addnotebook" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
			  <div class="modal-dialog">
			    <div class="modal-content">
			      ...
			      <div class="modal-body">
			        <!-- body of the dropdown model -->
			        	<div class="container">
									  <form:form action="savenewbook" modelAttribute="book" method="POST">
									  	
									  	
									  	 <label for="notebookname">Notebook Name : </label>
										<form:input type="text" path="notebookName"   name="username" placeholder="Ex: NPTEL" style=" border: 1px solid black;color:black"/>
				...
				<table id="example"
					...
					<tbody>
							...
							<c:forEach var="notebook" items="${notebook}">
								<c:url var="editing" value="editnotebook">
									<c:param name="id" value="${notebook.id}" />
								</c:url>
								<c:url var="deleting" value="deletenotebook">
									<c:param name="id" value="${notebook.id}" />
								</c:url>
								
							<c:if test="${notebook.username==user.username}">
							<tr>
								<td>${notebook.notebookName}</td>
								<td>${notebook.noteCount}</td>
								<td><a href="${editing}">EDIT</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="${deleting}">DELETE</a></td>
